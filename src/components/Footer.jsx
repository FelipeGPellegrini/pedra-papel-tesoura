    ...
    return (
        <div className='flex flex-col text-center'>
            ...
            <div className="fixed inset-0 bg-black opacity-50"></div>
                <div className={"bg-gray-400 w-65 h-500 overflow-y-auto text-center text-white p-5 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-2xl text-lg "}>
